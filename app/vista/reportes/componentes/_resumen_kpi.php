...
<div class="row g-4 mb-4">
    ...
    <div class="col-md">
        <div class="card shadow-sm border-0 rounded-4 bg-white h-100 border-start border-danger border-4">
            <div class="card-body p-3 d-flex align-items-center">
                <div class="icon-shape bg-danger bg-opacity-10 text-danger rounded-3 p-3 me-3">
                    <i class="bi bi-x-circle-fill fs-3"></i>
                </div>
                <div>
                    <h6 class="text-muted mb-0 small">Canceladas</h6>
                    <span class="h4 fw-bold mb-0 text-danger" id="kpi_cerradas">0</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card shadow-sm border-0 rounded-4 bg-white h-100 border-start border-success border-4">
            <div class="card-body p-3 d-flex align-items-center">
                ...
                <div>
                    ...
                    <span class="h4 fw-bold mb-0 text-success" id="kpi_efectividad">0%</span>
                </div>
            </div>
        </div>
    </div>
